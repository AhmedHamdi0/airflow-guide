...
# create table target_city_table as (select *airflow from source_city_table) with no data;
# select * from target_city_table;
# SELECT column_name, data_type, table_name FROM information_schema.columns WHERE table_name = 't1';
